                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppTheme.accentAI.withOpacity(0.1),
                          borderRadius: BorderRadius.circular(12),
                        ),
                        child: const Text(
                          "3 AI Modeli Kullanıldı",
                          style: TextStyle(color: AppTheme.accentAI, fontSize: 10, fontWeight: FontWeight.bold),
                        ),
                      ),
                    ],
                  ),
  ...
  Future<void> _saveToHistory(
    ...
    try {
      ...
      if (context.mounted) {
        ...
        FeedbackHandler.showSuccessDialog(context, message: 'Analiz Kaydedildi!');
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _ConfidenceProgress(confidence: analysis.confidence),
              ],
            ),
            const SizedBox(height: 12),
...
class _ConfidenceProgress extends StatelessWidget {
  final double confidence;
  const _ConfidenceProgress({required this.confidence});

  Color get _color {
    if (confidence >= 0.8) return AppTheme.accentAI;
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Icon(Icons.verified, size: 14, color: _color),
